...
\textit{Note that $\pd{^2f}{yx} = \pd{^2f}{xy}$, assuming continuity at $P_0$, by Clairaut's Theorem.} This, somewhat similarly to the Jacobian matrix defined earlier, is called the Hessian matrix of $f$.
