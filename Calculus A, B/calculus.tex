...
Given a function, $f(x,y)$, a common question is to find what direction it changes the fastest, ie, what direction should $\vec{u}$ be pointing to maximize $D_{\vec{u}}f(x,y)$? This is fairly simple to calculate using eqn. 97's definition of the gradient:
...
% !arc length
% !jacobian
% !replace eqn with actual references
\end{document}