...
A final small note; to determine the direction of $\hat{N}$ along a planar curve, one must consider the curvature; $\hat{N}$ always points towards "inside" of curve, ie, along increasing angle of $\hat{T}$ with the horizontal.
