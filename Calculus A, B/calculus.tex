...
\begin{align*}
    &= \int_{0}^{\infty}\int_{0}^{\pi} e^{-(r^2\cos^2 \theta+r^2\sin^2\theta)} r\, \text{d}\theta\text{d}r\\
    &= \pi \int_{0}^{\infty}r e^{-r^2} \,\text{d}r\\
    &= -\frac{\pi}{2}\left[e^{-r^2}\right]_0^{\infty} = \frac{\pi}{2}
\end{align*}

Thus, $I^2 = \frac{\pi}{2} \implies I = \frac{\sqrt{\pi}}{2}.$
