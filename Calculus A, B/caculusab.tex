...
\newpagestyle{mypage}{%
  \headrule
  \sethead{}{\textit{\textcolor{gray}{(\thesubsection) \sectiontitle: \subsectiontitle}}}{}
...
\begin{itemize}
    ...
    \begin{equation}
        \begin{split}
            \dydx &= \frac{k}{N}y(N-y)\\
            \frac{dy}{y(N-y)} &= \frac{k dx}{N}\\
            \int \frac{dy}{y(N-y)} &= \int \frac{k dx}{N}\\
            \int [\frac{\frac{1}{N}}{y} + \frac{\frac{1}{N}}{N-y}] dy &= \frac{k}{N} x + C\\
            \frac{1}{N}(\ln|y| - ln|N-y|) &= \frac{k}{N} x + C\\
            \ln|\frac{y}{N-y}| &= kx + D, D = CN\\
            \frac{y}{N-y} &= Ke^{kx}, K = \pm e^D\\
            y &= \frac{NKe^{kx}}{1+Ke^{kx}} =\frac{NKe^{kx}}{1+Ke^{kx}} \frac{\frac{e^{-kt}}{K}}{\frac{e^{-kt}}{K}}\\
