...
\newcommand{\pagetitle}{Nonlinear Dynamics, Chaos}
...
\begin{mdframed}[backgroundcolor=gray!20]
  ...
  \textit{Graphical and algebraic analysis of dynamical systems in one and multiple dimensions. Basic bifurcation theory. Fractals, chaos. Linear stability analysis. Numerical methods. Focused more on methods rather than theory.}
\end{mdframed}
\tableofcontents
