...
\begin{proof}
  ...
  Consider $m$ fixed. Then, $\chi_m (x) = \lim_{n\to\infty} \cos^n(\pi m! x)$. We claim that $\chi_m(x) = 0 \forall x \in \mathbb{J}$. Note that % TODO: prove that cos^n goes to 0 for non 2pi answers
