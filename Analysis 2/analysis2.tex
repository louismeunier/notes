...
\newcommand{\pagedescription}{Basic point-set topology; metric spaces; Hölder-Minkowski Inequalities; compactness; series, series of functions, uniform and pointwise convergence.}
\newcommand{\pagesemester}{Winter, 2024 }
\newcommand{\pageprofessor}{Prof. Dimitry Jakobson}
