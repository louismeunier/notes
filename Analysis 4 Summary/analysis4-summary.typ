...
#definition("Weak Convergence")[
 ...
 We define, then, $sigma(X, X^ast)$ to be the weak topology (on $X$) generated by the collection of families $X^ast$; i.e., the coarsest topology for which every functional $T in X^ast$ is continuous.
]
