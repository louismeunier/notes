...
\newcommand{\pagedescription}{Vector spaces, linear (in)dependence, span, bases; linear transformations, kernel, image, isomorphisms.}
...
%   \underline{Course Outline:} \textit{Vector spaces,  subspaces, linear (in)dependence, span, bases; linear transformations, kernel, image, isomorphisms, matrix representations.}\\
%   \underline{Texts:} \textit{Algebra (Artin)}
%   \\\\\textit{
