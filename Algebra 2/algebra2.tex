...
\newcommand{\pagedescription}{Vector spaces, linear (in)dependence, span, bases; linear transformations, kernel, image, isomorphisms, nilpotent operators; elementary matrices; diagonalization, eigenthings, Cayley-Hamilton; inner product spaces.}
